...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private void addingToCartList() {
        ...
        cartListRef.child("User view").child(Prevalent.currentOnlineUser.getEmail()).child("Products").child(productID).updateChildren(cartMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
