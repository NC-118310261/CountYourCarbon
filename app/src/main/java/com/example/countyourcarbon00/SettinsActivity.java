...
public class SettinsActivity extends AppCompatActivity {
    ...
    private void updateOnlyUserInfo() {
        ...
        ref.child(Prevalent.currentOnlineUser.getSchool()).updateChildren(userMap);
    ...
    private void uploadImage() {
        ...
        if (imageUri != null)
        {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(Prevalent.currentOnlineUser.getSchool() + ".jpg");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currentOnlineUser.getSchool());
